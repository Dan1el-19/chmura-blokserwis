...
export class NotificationManager {
	...
	private async checkPermission(): Promise<void> {
		...
		if (this.permission === 'default') {
			try {
				...
				console.warn('Nie udało się poprosić o uprawnienia do notifications:', error);
			}
		}
	}
	...
	public async notifyUploadError(fileName: string, error: string): Promise<void> {
	...
	public async notifyUploadProgress(fileName: string, progress: number): Promise<void> {
