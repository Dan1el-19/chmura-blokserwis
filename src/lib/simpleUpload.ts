...
export class SimpleUploadManager {
	...
	constructor(options: { events?: UploadManagerEvents; getAuthHeader: () => Promise<string | null>; maxConcurrentUploads?: number }) {
	...
	public async importSessions(): Promise<{ imported: number; errors: string[] }> {
