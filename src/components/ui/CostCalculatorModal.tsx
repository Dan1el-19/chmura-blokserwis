      ...
      <div className="bg-white rounded-t-2xl sm:rounded-xl shadow-xl w-full sm:max-w-md max-h-[90vh] overflow-y-auto">
        ...
        <div className="p-4 sm:p-6 space-y-4 sm:space-y-6 pb-safe">
          ...
          <div className="bg-gray-50 rounded-lg p-3 sm:p-4">
            <h3 className="font-medium text-gray-900 mb-2 text-sm sm:text-base">Informacje o pliku</h3>
            <div className="space-y-1 text-xs sm:text-sm text-gray-600">
              <p><span className="font-medium">Nazwa:</span> <span className="break-all">{file.name}</span></p>
          ...
          <div className="space-y-3 sm:space-y-4">
            <h3 className="font-medium text-gray-900 text-sm sm:text-base">Parametry kalkulacji</h3>
             ...
             <div>
               <div className="flex flex-col sm:flex-row sm:items-center justify-between mb-2 gap-2">
                 ...
                 <div className="flex items-center gap-2">
                   ...
                   />
                   <label htmlFor="indefinite" className="text-xs sm:text-sm text-gray-600">
                     Bezterminowo
                   </label>
                 </div>
               </div>
