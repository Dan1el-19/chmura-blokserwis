...
import { X, Download, Share2, Link, BarChart3, FileText, Trash2, FolderEdit } from 'lucide-react';
        ...
        <div className="px-4 pb-3 border-b border-gray-100">
          <div className="flex items-center justify-between gap-3">
            <div className="min-w-0 flex-1">
              <h3 className="text-base font-semibold text-gray-900 truncate" title={itemName}>
                {itemName}
              </h3>
              {isFile && file && (
          ...
          {isFile ? (
            ...
            <>
              ...
              >
                ...
                <span className="text-base text-gray-900">Zarządzaj linkami</span>
              </button>
