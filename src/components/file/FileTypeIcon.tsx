...
export const FileTypeIcon: React.FC<FileTypeIconProps> = ({
  ...
  const containerClasses = clsx(
    "flex flex-col items-center justify-center rounded-xl border font-semibold select-none",
    sizeStyles[size],
  ...
  switch (category) {
    case "archive":
      IconEl = <FileArchive {...iconProps} />;
      break;
    case "audio":
      IconEl = <FileAudio2 {...iconProps} />;
      break;
    case "video":
      IconEl = <FileVideo2 {...iconProps} />;
      break;
    case "code":
      IconEl = <FileCode2 {...iconProps} />;
      break;
    case "image":
      IconEl = <FileImage {...iconProps} />;
      break;
    case "pdf":
      IconEl = <FileText {...iconProps} />;
      break;
    case "text":
      IconEl = <FileText {...iconProps} />;
      break;
    default:
      IconEl = <FileGeneric {...iconProps} />;
      break;
  }
  ...
  return (
    <div
      ...
      aria-label={`Typ pliku ${label}`}
      title={label}
    >
      {IconEl}
      {showLabel && (
        <span className="uppercase tracking-tight leading-none mt-0.5 text-[0.6rem] md:text-[0.65rem]">
          {label}
        </span>
      )}
    </div>
